...
namespace SimLab1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[2].Name = "0.1";
            dataGridView1.Columns[3].Name = "0.01";
            dataGridView1.Columns[4].Name = "0.001";
            dataGridView1.Columns[5].Name = "0.0001";
        ...
        {
            double[] dts = new double[5] { 1.0, 0.1, 0.01, 0.001, 0.0001 };
...
![skrinn.png](./skrin.png)

| Шаг моделирования, с | 1 | 0.1 | 0.01 | 0.001 | 0.0001 |
|----------------------|---|-----|------|-------|--------|
| Дальность полёта, м |  0.25 |  8.17   |  8.79  |   8.85  |     8.86   |
| Максимальная высота, м | 0.42 | 11.42|  11.82   |   11.86  |   11.87  |
| Скорость в конечной точке, м/с |10.51 | 9.60|  9.54  |  9.54 |  9.54  |


**Выводы.**
По результатам вычислений выяснилось, что нормальные результаты начинаются с шагом 0.01 и меньше
Уменьшение шага после 0.001 практически не меняет точность результата, но стоит на порядки дороже в процессорном времени.